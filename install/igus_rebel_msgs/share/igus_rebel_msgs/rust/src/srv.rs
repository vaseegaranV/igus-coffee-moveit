...
pub struct SetDigitalOutput_Request {
    ...
    #[allow(missing_docs)]
    pub output: super::msg::DigitalOutput,
...
impl Default for SetDigitalOutput_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::SetDigitalOutput_Request::default())
  }
}

impl rosidl_runtime_rs::Message for SetDigitalOutput_Request {
  type RmwMsg = super::srv::rmw::SetDigitalOutput_Request;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        output: super::msg::DigitalOutput::into_rmw_message(std::borrow::Cow::Owned(msg.output)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        output: super::msg::DigitalOutput::into_rmw_message(std::borrow::Cow::Borrowed(&msg.output)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      output: super::msg::DigitalOutput::from_rmw_message(msg.output),
    }
  }
}
...
impl Default for SetDigitalOutput_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::SetDigitalOutput_Response::default())
  }
}

impl rosidl_runtime_rs::Message for SetDigitalOutput_Response {
  type RmwMsg = super::srv::rmw::SetDigitalOutput_Response;
