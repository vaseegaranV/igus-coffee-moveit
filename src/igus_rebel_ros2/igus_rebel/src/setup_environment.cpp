...
void SimpleTask::setupPlanningScene()
{
    ...
    // Offset applied to all mesh objects
    const double OX = +0.030;
    const double OY = -0.042;
    const double OZ = -0.012;
    ...
    // ── Walls ──────────────────────────────────────────────────────────────
    {
        ...
        wall_front_color.color.r = 0.7; wall_front_color.color.g = 0.7;
        wall_front_color.color.b = 0.7; wall_front_color.color.a = 0.4;
        ...
        wall_left_color.color.r = 0.7; wall_left_color.color.g = 0.7;
        wall_left_color.color.b = 0.7; wall_left_color.color.a = 0.4;
        ...
        wall_right_color.color.r = 0.7; wall_right_color.color.g = 0.7;
        wall_right_color.color.b = 0.7; wall_right_color.color.a = 0.4;
    ...
    // ── Ceiling ────────────────────────────────────────────────────────────
    {
        ...
        ceiling_color.color.r = 0.8; ceiling_color.color.g = 0.8;
        ceiling_color.color.b = 0.9; ceiling_color.color.a = 0.3;
    ...
    // ── Welding table ──────────────────────────────────────────────────────
    {
        ...
        table_color.color.r = 0.3; table_color.color.g = 0.3;
        table_color.color.b = 0.35; table_color.color.a = 0.9;
    ...
    // ── Coffee cup (mesh) ──────────────────────────────────────────────────
    {
        ...
        if (mesh)
        {
            ...
            cup_color.id = "object";
            cup_color.color.r = 0.2; cup_color.color.g = 0.7;
            cup_color.color.b = 0.9; cup_color.color.a = 1.0;
    ...
    // ── Grinder (mesh) ─────────────────────────────────────────────────────
    {
        ...
        if (mesh)
        {
            ...
            grinder_color.color.r = 0.3; grinder_color.color.g = 0.8;
            grinder_color.color.b = 0.9; grinder_color.color.a = 1.0;
    ...
    // ── Coffee machine (mesh) ──────────────────────────────────────────────
    {
        ...
        if (mesh)
        {
            ...
            mesh_msg = boost::get<shape_msgs::msg::Mesh>(mesh_msg_variant);
            geometry_msgs::msg::Pose pose;
            pose.position.x = -0.356 + OX;
            pose.position.y = -0.457 + OY;
            pose.position.z = 0.020 + OZ;
            pose.orientation.w = 1.0;
            ...
            coffee_machine_color.color.r = 0.2; coffee_machine_color.color.g = 0.6;
            coffee_machine_color.color.b = 0.2; coffee_machine_color.color.a = 1.0;
    ...
    // ── Tool station (mesh) ────────────────────────────────────────────────
    {
        ...
        if (mesh)
        {
            ...
            mesh_msg = boost::get<shape_msgs::msg::Mesh>(mesh_msg_variant);
            geometry_msgs::msg::Pose pose;
            pose.position.x = -0.715 + OX;
            pose.position.y = -0.188 + OY;
            pose.position.z = 0.405 + OZ;
            pose.orientation.x = 0.0;
            pose.orientation.y = 0.0;
            ...
            tool_station_color.color.r = 0.7; tool_station_color.color.g = 0.1;
            tool_station_color.color.b = 0.8; tool_station_color.color.a = 1.0;
    ...
    // ── Cup holder (mesh) ──────────────────────────────────────────────────
    {
        ...
        if (mesh)
        {
            ...
            mesh_msg = boost::get<shape_msgs::msg::Mesh>(mesh_msg_variant);
            geometry_msgs::msg::Pose pose;
            pose.position.x = -0.527 + OX;
            pose.position.y = -0.240 + OY;
            pose.position.z = 0.407 + OZ;
            pose.orientation.x = 0.0;
            pose.orientation.y = 0.0;
            pose.orientation.z = -0.7071;
            pose.orientation.w = 0.7071;
    ...
    // ── Portafilter (mesh) ──────────────────────────────────────────────────
    {
        ...
        if (mesh)
        {
            ...
            mesh_msg = boost::get<shape_msgs::msg::Mesh>(mesh_msg_variant);
            geometry_msgs::msg::Pose pose;
            pose.position.x = -0.663 + OX;
            pose.position.y = -0.071 + OY;
            pose.position.z = 0.379 + OZ;
            pose.orientation.x = 0.0;
            pose.orientation.y = 0.0;
            pose.orientation.z = -0.7071;
            pose.orientation.w = 0.7071;
    ...
    // ── Tamping Station (mesh) ──────────────────────────────────────────────────
    {
        ...
        if (mesh)
        {
            ...
            tamping_station_color.color.r = 0.1; tamping_station_color.color.g = 0.1;
            tamping_station_color.color.b = 0.1; tamping_station_color.color.a = 0.5;
    ...
    // ── Delivery Station (mesh) ──────────────────────────────────────────────────
    {
        ...
        if (mesh)
        {
            ...
            delivery_station_color.color.r = 0.8; delivery_station_color.color.g = 0.1;
            delivery_station_color.color.b = 0.3; delivery_station_color.color.a = 1.0;
