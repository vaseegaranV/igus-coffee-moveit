...
static const _DigitalOutput_type_support_symbol_names_t _DigitalOutput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, igus_rebel_msgs, msg, DigitalOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, igus_rebel_msgs, msg, DigitalOutput)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, igus_rebel_msgs, msg, DigitalOutput)() {
  return &::igus_rebel_msgs::msg::rosidl_typesupport_c::DigitalOutput_message_type_support_handle;
}
