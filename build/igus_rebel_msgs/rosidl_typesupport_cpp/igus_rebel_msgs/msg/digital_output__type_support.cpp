...
static const _DigitalOutput_type_support_symbol_names_t _DigitalOutput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, igus_rebel_msgs, msg, DigitalOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, igus_rebel_msgs, msg, DigitalOutput)),
  }
};
...
{
  return &::igus_rebel_msgs::msg::rosidl_typesupport_cpp::DigitalOutput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, igus_rebel_msgs, msg, DigitalOutput)() {
  return get_message_type_support_handle<igus_rebel_msgs::msg::DigitalOutput>();
}
